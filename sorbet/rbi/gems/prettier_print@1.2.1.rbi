...
class PrettierPrint
  ...
  def group(indent = T.unsafe(nil), open_object = T.unsafe(nil), close_object = T.unsafe(nil),
            open_width = T.unsafe(nil), close_width = T.unsafe(nil))
  end
  ...
  class << self
    ...
    def format(output = T.unsafe(nil), maxwidth = T.unsafe(nil), newline = T.unsafe(nil), genspace = T.unsafe(nil),
               indentation = T.unsafe(nil))
    end
    ...
    def singleline_format(output = T.unsafe(nil), _maxwidth = T.unsafe(nil), _newline = T.unsafe(nil),
                          _genspace = T.unsafe(nil))
    end
  end
end
...
class PrettierPrint::SingleLine
  ...
  def group(_indent = T.unsafe(nil), open_object = T.unsafe(nil), close_object = T.unsafe(nil),
            _open_width = T.unsafe(nil), _close_width = T.unsafe(nil))
  end
