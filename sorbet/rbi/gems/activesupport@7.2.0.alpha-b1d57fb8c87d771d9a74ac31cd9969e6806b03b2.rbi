...
class ActiveSupport::BacktraceCleaner
  ...
  #
  # source://activesupport//lib/active_support/backtrace_cleaner.rb#82
  ...
  #
  # source://activesupport//lib/active_support/backtrace_cleaner.rb#91
  ...
  # filtered out.
  #
  # source://activesupport//lib/active_support/backtrace_cleaner.rb#105
  ...
  #
  # source://activesupport//lib/active_support/backtrace_cleaner.rb#98
  def remove_silencers!; end

  private

  # source://activesupport//lib/active_support/backtrace_cleaner.rb#112
  def add_gem_filter; end

  # source://activesupport//lib/active_support/backtrace_cleaner.rb#121
  def add_gem_silencer; end

  # source://activesupport//lib/active_support/backtrace_cleaner.rb#125
  def add_stdlib_silencer; end

  # source://activesupport//lib/active_support/backtrace_cleaner.rb#129
  def filter_backtrace(backtrace); end

  # source://activesupport//lib/active_support/backtrace_cleaner.rb#145
  def noise(backtrace); end

  # source://activesupport//lib/active_support/backtrace_cleaner.rb#137
...
class ActiveSupport::Cache::Store
  ...
  #
  # source://activesupport//lib/active_support/cache.rb#755
  def cleanup(options = T.unsafe(nil)); end
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#746
  def decrement(name, amount = T.unsafe(nil), options = T.unsafe(nil)); end
  ...
  # Options are passed to the underlying cache implementation.
  #
  # source://activesupport//lib/active_support/cache.rb#682
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#728
  def delete_matched(matcher, options = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/cache.rb#709
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#737
  def increment(name, amount = T.unsafe(nil), options = T.unsafe(nil)); end
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#864
  def delete_entry(key, **options); end
  ...
  # source://activesupport//lib/active_support/cache.rb#1042
  ...
  # source://activesupport//lib/active_support/cache.rb#1017
  ...
  #
  # source://activesupport//lib/active_support/cache.rb#875
  ...
  #   # => 'cache:foo'
  #
  # source://activesupport//lib/active_support/cache.rb#962
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#810
  def read_entry(key, **options); end

  # Reads multiple entries from the cache implementation. Subclasses MAY
  # implement this method.
  #
  # source://activesupport//lib/active_support/cache.rb#837
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#816
  def write_entry(key, entry, **options); end
...
# source://activesupport//lib/active_support/cache.rb#1075
...
class ActiveSupport::Duration
  ...
  #
  # source://activesupport//lib/active_support/duration.rb#309
  def %(other); end

  # Multiplies this Duration by a Numeric and returns a new Duration.
  #
  # source://activesupport//lib/active_support/duration.rb#284
  def *(other); end

  # Adds another Duration or a Numeric to this Duration. Numeric values
  # are treated as seconds.
  #
  # source://activesupport//lib/active_support/duration.rb#265
  def +(other); end

  # source://activesupport//lib/active_support/duration.rb#323
  def +@; end

  # Subtracts another Duration or a Numeric from this Duration. Numeric
  # values are treated as seconds.
  #
  # source://activesupport//lib/active_support/duration.rb#279
  def -(other); end

  # source://activesupport//lib/active_support/duration.rb#319
  def -@; end
  ...
  #
  # source://activesupport//lib/active_support/duration.rb#338
  def ==(other); end

  # source://activesupport//lib/active_support/duration.rb#478
  def _parts; end
  ...
  #
  # source://activesupport//lib/active_support/duration.rb#433
  def after(time = T.unsafe(nil)); end

  # Calculates a new Time or Date that is as far in the past
  # as this Duration represents.
  #
  # source://activesupport//lib/active_support/duration.rb#441
  def ago(time = T.unsafe(nil)); end

  # source://activesupport//lib/active_support/duration.rb#456
  ...
  # source://activesupport//lib/active_support/duration.rb#242
  def coerce(other); end

  # source://activesupport//lib/active_support/duration.rb#464
  ...
  # source://activesupport//lib/active_support/duration.rb#427
  def hash; end
  ...
  #   1.day.in_hours # => 24.0
  #
  # source://activesupport//lib/active_support/duration.rb#389
  def in_hours; end
  ...
  #
  # source://activesupport//lib/active_support/duration.rb#410
  def in_months; end
  ...
  #
  # source://activesupport//lib/active_support/duration.rb#374
  def in_seconds; end
  ...
  # source://activesupport//lib/active_support/duration.rb#460
  ...
  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/duration.rb#332
  def instance_of?(klass); end

  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/duration.rb#327
  def is_a?(klass); end

  # Build ISO 8601 Duration string for this duration.
  # The +precision+ parameter can be used to limit seconds' precision of duration.
  #
  # source://activesupport//lib/active_support/duration.rb#470
  ...
  # source://activesupport//lib/active_support/duration.rb#224
  def negative?(&block); end

  # Returns a copy of the parts hash that defines the duration
  #
  # source://activesupport//lib/active_support/duration.rb#238
  def parts; end

  # source://activesupport//lib/active_support/duration.rb#224
  def positive?(&block); end
  ...
  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/duration.rb#474
  def variable?; end
  ...
  # source://activesupport//lib/active_support/duration.rb#509
  def method_missing(method, *args, &block); end

  # @raise [TypeError]
  #
  # source://activesupport//lib/active_support/duration.rb#513
  def raise_type_error(other); end

  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/duration.rb#505
  def respond_to_missing?(method, _); end

  # source://activesupport//lib/active_support/duration.rb#483
...
class ActiveSupport::EncryptedConfiguration < ::ActiveSupport::EncryptedFile
  ...
  # source://activesupport//lib/active_support/core_ext/module/delegation.rb#339
...
class ActiveSupport::HashWithIndifferentAccess < ::Hash
  ...
  # source://activesupport//lib/active_support/hash_with_indifferent_access.rb#396
  ...
  # source://activesupport//lib/active_support/hash_with_indifferent_access.rb#422
  def set_defaults(target); end

  # source://activesupport//lib/active_support/hash_with_indifferent_access.rb#430
...
class ActiveSupport::InheritableOptions < ::ActiveSupport::OrderedOptions
  ...
  # source://activesupport//lib/active_support/ordered_options.rb#146
  def each(&block); end
...
class ActiveSupport::SyntaxErrorProxy
  ...
  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/syntax_error_proxy.rb#59
...
class Module
  ...
  def delegate(*methods, to: T.unsafe(nil), prefix: T.unsafe(nil), allow_nil: T.unsafe(nil), private: T.unsafe(nil), as: T.unsafe(nil)); end
  ...
  #
  # source://activesupport//lib/active_support/core_ext/module/delegation.rb#326
