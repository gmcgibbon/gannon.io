...
module Capybara
  ...
  class << self
    ...
    #
    # source://capybara//lib/capybara.rb#387
    def HTML(html); end
    ...
    #
    # source://capybara//lib/capybara.rb#180
    ...
    # @yield [config]
    #
    # source://capybara//lib/capybara.rb#112
    def configure; end

    # @return [Symbol] The name of the driver currently in use
    #
    # source://capybara//lib/capybara.rb#259
    ...
    #
    # source://capybara//lib/capybara.rb#314
    ...
    # source://capybara//lib/capybara.rb#202
    def drivers; end
    ...
    #
    # source://capybara//lib/capybara.rb#198
    ...
    #
    # source://capybara//lib/capybara.rb#129
    ...
    #
    # source://capybara//lib/capybara.rb#148
    ...
    # as cookies.
    #
    # source://capybara//lib/capybara.rb#323
    def reset!; end
    ...
    #
    # source://capybara//lib/capybara.rb#251
    ...
    # source://capybara//lib/capybara.rb#206
    def servers; end
    ...
    #
    # source://capybara//lib/capybara.rb#335
    def session_name; end

    # source://capybara//lib/capybara.rb#343
    def session_name=(name); end

    # source://capybara//lib/capybara.rb#407
    ...
    #
    # source://capybara//lib/capybara.rb#238
    def string(html); end
    ...
    #
    # source://capybara//lib/capybara.rb#280
    ...
    # source://capybara//lib/capybara.rb#413
    def config; end

    # source://capybara//lib/capybara.rb#417
    def session_pool; end

    # source://capybara//lib/capybara.rb#423
    def specified_session; end

    # source://capybara//lib/capybara.rb#431
...
module Capybara::DSL
  # source://capybara//lib/capybara/dsl.rb#52
...
# source://capybara//lib/capybara.rb#444
...
class Capybara::Driver::Node
  ...
  # source://capybara//lib/capybara/driver/node.rb#134
  def ==(other); end
...
module Capybara::Node::Actions
  ...
  def fill_in(locator = T.unsafe(nil), with:, currently_with: T.unsafe(nil), fill_options: T.unsafe(nil),
              **find_options)
  end
...
class Capybara::Node::Element < Capybara::Node::Base
  ...
  #
  # source://capybara//lib/capybara/node/element.rb#518
  def evaluate_async_script(script, *args); end
  ...
  # @return [Object] The result of the evaluated JavaScript (may be driver specific)
  #
  # source://capybara//lib/capybara/node/element.rb#501
  def evaluate_script(script, *args); end
  ...
  #
  # source://capybara//lib/capybara/node/element.rb#484
  def execute_script(script, *args); end
  ...
  # @return [Capybara::Node::Element] The element
  #
  # source://capybara//lib/capybara/node/element.rb#531
  def flash; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/node/element.rb#575
  def initial_cache; end
  ...
  #
  # source://capybara//lib/capybara/node/element.rb#566
  def inspect; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/node/element.rb#549
  def reload; end
  ...
  # @raise [ArgumentError]
  #
  # source://capybara//lib/capybara/node/element.rb#593
  def perform_click_action(keys, wait: T.unsafe(nil), **options); end
end

# source://capybara//lib/capybara/node/element.rb#579
...
module Capybara::Node::Finders
  ...
  #
  # source://capybara//lib/capybara/node/finders.rb#248
  ...
  #
  # source://capybara//lib/capybara/node/finders.rb#74
  ...
  # @return [Capybara::Node::Element] The found element
  #
  # source://capybara//lib/capybara/node/finders.rb#175
  ...
  # @return [Capybara::Node::Element] The found element
  #
  # source://capybara//lib/capybara/node/finders.rb#189
  ...
  # @return [Capybara::Node::Element] The found element
  #
  # source://capybara//lib/capybara/node/finders.rb#128
  ...
  #
  # source://capybara//lib/capybara/node/finders.rb#284
  ...
  # @return [Capybara::Node::Element] The found element
  #
  # source://capybara//lib/capybara/node/finders.rb#97
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/finders.rb#309
  def ambiguous?(query, result); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/finders.rb#317
  def options_include_minimum?(opts); end

  # source://capybara//lib/capybara/node/finders.rb#321
  def parent; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/node/finders.rb#313
...
class Capybara::Queries::SelectorQuery < Capybara::Queries::BaseQuery
  ...
  def initialize(*args, session_options:, enable_aria_label: T.unsafe(nil), enable_aria_role: T.unsafe(nil),
                 test_id: T.unsafe(nil), selector_format: T.unsafe(nil), order: T.unsafe(nil), **options, &filter_block)
  end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#107
  def applied_description; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#148
  def css; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#58
  def description(only_applied = T.unsafe(nil)); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#131
  def exact?; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#56
  def label; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#135
  def match; end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#111
  def matches_filters?(node, node_filter_errors = T.unsafe(nil)); end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#55
  def name; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#176
  def negative_failure_message; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#153
  def resolve_for(node, exact = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#166
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#139
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#384
  def apply_expression_filters(expression); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#427
  def apply_filter?(filter); end

  # @api private
  # @raise [ArgumentError]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#338
  def assert_valid_keys; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#598
  def builder(expr); end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#334
  def custom_keys; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#594
  def default_visibility; end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#415
  def describe_within?; end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#419
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#319
  def expression_filters; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#307
  def filter_set(name); end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#356
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#228
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#550
  def matches_exact_text_filter?(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#297
  def matches_filter_block?(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#504
  def matches_focused_filter?(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#485
  def matches_id_filter?(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#431
  def matches_locator_filter?(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#272
  def matches_node_filters?(node, errors); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#449
  def matches_spatial_filters?(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#530
  def matches_style?(node, styles); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#519
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#579
  def matches_text_exactly?(node, value); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#541
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#311
  def node_filters; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#584
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#602
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#218
  def show_for_stage(only_applied); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#423
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#260
  def to_element(node); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#207
  def try_text_match_in_expression?; end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#368
  def use_default_class_filter?; end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#376
  def use_default_focused_filter?; end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#364
  def use_default_id_filter?; end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#372
  def use_default_style_filter?; end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#380
  def use_spatial_filter?; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#268
  def valid_keys; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#405
  def warn_exact_usage; end

  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#194
...
class Capybara::Queries::SelectorQuery::Rectangle
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#641
  def below?(other); end
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#645
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#649
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#659
  ...
  # @api private
  #
  # source://capybara//lib/capybara/queries/selector_query.rb#670
...
class Capybara::RackTest::Browser
  ...
  # source://capybara//lib/capybara/rack_test/browser.rb#75
  ...
  # source://capybara//lib/capybara/rack_test/browser.rb#87
  def current_url; end

  # source://capybara//lib/capybara/rack_test/browser.rb#104
  def dom; end
  ...
  # source://capybara//lib/capybara/rack_test/browser.rb#39
  ...
  # source://capybara//lib/capybara/rack_test/browser.rb#66
  def process(method, path, attributes = T.unsafe(nil), env = T.unsafe(nil)); end

  # source://capybara//lib/capybara/rack_test/browser.rb#45
  def process_and_follow_redirects(method, path, attributes = T.unsafe(nil), env = T.unsafe(nil)); end

  # source://capybara//lib/capybara/rack_test/browser.rb#27
  def refresh; end

  # source://capybara//lib/capybara/rack_test/browser.rb#100
  def reset_cache!; end

  # source://capybara//lib/capybara/rack_test/browser.rb#95
  def reset_host!; end

  # source://capybara//lib/capybara/rack_test/browser.rb#32
  ...
  # source://capybara//lib/capybara/rack_test/browser.rb#133
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/rack_test/browser.rb#141
...
class Capybara::RegistrationContainer
  ...
  #
  # source://capybara//lib/capybara/registration_container.rb#36
  def initialize; end
  ...
  # @api private
  #
  # source://capybara//lib/capybara/registration_container.rb#40
  def register(name, block); end

  # @api private
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/registration_container.rb#30
...
class Capybara::Selector < SimpleDelegator
  ...
  # source://capybara//lib/capybara/selector/selector.rb#73
  def add_error(error_msg); end

  # @api private
  #
  # source://capybara//lib/capybara/selector/selector.rb#91
  ...
  # @api private
  #
  # source://capybara//lib/capybara/selector/selector.rb#82
  ...
  # source://capybara//lib/capybara/selector/selector.rb#151
  def find_by_class_attr(classes); end

  # source://capybara//lib/capybara/selector/selector.rb#122
  def locate_field(xpath, locator, **_options); end

  # source://capybara//lib/capybara/selector/selector.rb#138
  def locate_label(locator); end

  # source://capybara//lib/capybara/selector/selector.rb#104
  def locator_description; end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selector/selector.rb#114
...
class Capybara::Selector::Definition
  ...
  def initialize(name, locator_type: T.unsafe(nil), raw_locator: T.unsafe(nil), supports_exact: T.unsafe(nil), &block)
  end
  ...
  # source://capybara//lib/capybara/selector/definition.rb#267
...
class Capybara::Selenium::Driver < Capybara::Driver::Base
  ...
  # source://capybara//lib/capybara/selenium/driver.rb#535
  ...
  # source://capybara//lib/capybara/selenium/driver.rb#488
  ...
  # source://capybara//lib/capybara/selenium/driver.rb#517
  ...
  # source://capybara//lib/capybara/selenium/driver.rb#522
...
module Capybara::Selenium::Find
  ...
  def find_css(selector, uses_visibility: T.unsafe(nil), texts: T.unsafe(nil), styles: T.unsafe(nil),
               position: T.unsafe(nil), **_options)
  end

  # source://capybara//lib/capybara/selenium/extensions/find.rb#6
  def find_xpath(selector, uses_visibility: T.unsafe(nil), styles: T.unsafe(nil), position: T.unsafe(nil), **_options)
  end
...
class Capybara::Selenium::Node < Capybara::Driver::Node
  ...
  # source://capybara//lib/capybara/selenium/node.rb#103
  def click(keys = T.unsafe(nil), **options); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/node.rb#198
  ...
  # source://capybara//lib/capybara/selenium/node.rb#164
  def drag_to(element, drop_modifiers: T.unsafe(nil), **_arg2); end

  # @raise [NotImplementedError]
  #
  # source://capybara//lib/capybara/selenium/node.rb#177
  def drop(*_); end

  # source://capybara//lib/capybara/selenium/node.rb#160
  def hover; end
  ...
  # source://capybara//lib/capybara/selenium/node.rb#213
  def rect; end

  # source://capybara//lib/capybara/selenium/node.rb#130
  def right_click(keys = T.unsafe(nil), **options); end
  ...
  # source://capybara//lib/capybara/selenium/node.rb#156
  def send_keys(*args); end
  ...
  #
  # source://capybara//lib/capybara/selenium/node.rb#56
  def set(value, **options); end
  ...
  # source://capybara//lib/capybara/selenium/node.rb#404
  def action_with_modifiers(click_options); end

  # source://capybara//lib/capybara/selenium/node.rb#475
  def attrs(*attr_names); end

  # source://capybara//lib/capybara/selenium/node.rb#288
  def auto_rapid_set_length; end

  # source://capybara//lib/capybara/selenium/node.rb#257
  def boolean_attr(val); end

  # source://capybara//lib/capybara/selenium/node.rb#435
  def bridge; end

  # source://capybara//lib/capybara/selenium/node.rb#431
  def browser; end

  # source://capybara//lib/capybara/selenium/node.rb#439
  def browser_action; end

  # source://capybara//lib/capybara/selenium/node.rb#471
  def build_node(native_node, initial_cache = T.unsafe(nil)); end

  # source://capybara//lib/capybara/selenium/node.rb#443
  def capabilities; end

  # source://capybara//lib/capybara/selenium/node.rb#463
  def each_key(keys, &block); end

  # source://capybara//lib/capybara/selenium/node.rb#467
  def find_context; end

  # source://capybara//lib/capybara/selenium/node.rb#421
  def modifiers_down(actions, keys); end

  # source://capybara//lib/capybara/selenium/node.rb#426
  ...
  # @raise [ArgumentError]
  #
  # source://capybara//lib/capybara/selenium/node.rb#292
  def perform_with_options(click_options, &block); end

  # a reference to the select node if this is an option node
  #
  # source://capybara//lib/capybara/selenium/node.rb#262
  def select_node; end

  # source://capybara//lib/capybara/selenium/node.rb#330
  def set_color(value); end

  # source://capybara//lib/capybara/selenium/node.rb#380
  def set_content_editable(value); end

  # source://capybara//lib/capybara/selenium/node.rb#306
  def set_date(value); end

  # source://capybara//lib/capybara/selenium/node.rb#322
  def set_datetime_local(value); end

  # source://capybara//lib/capybara/selenium/node.rb#352
  def set_file(value); end

  # source://capybara//lib/capybara/selenium/node.rb#334
  def set_range(value); end

  # source://capybara//lib/capybara/selenium/node.rb#266
  def set_text(value, clear: T.unsafe(nil), rapid: T.unsafe(nil), **_unused); end

  # source://capybara//lib/capybara/selenium/node.rb#314
  def set_time(value); end

  # source://capybara//lib/capybara/selenium/node.rb#243
  def sibling_index(parent, node, selector); end

  # source://capybara//lib/capybara/selenium/node.rb#338
...
class Capybara::Selenium::Node::ClickOptions
  ...
  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/node.rb#595
  def coords?; end
...
# source://capybara//lib/capybara/selenium/node.rb#493
...
# source://capybara//lib/capybara/selenium/node.rb#525
...
#
# source://capybara//lib/capybara/selenium/node.rb#553
class Capybara::Selenium::Node::SettableValue
  # @return [SettableValue] a new instance of SettableValue
  #
  # source://capybara//lib/capybara/selenium/node.rb#556
  def initialize(value); end

  # @return [Boolean]
  #
  # source://capybara//lib/capybara/selenium/node.rb#564
  def dateable?; end
  ...
  # source://capybara//lib/capybara/selenium/node.rb#560
  def to_s; end
...
class Capybara::Server
  ...
  def initialize(app, *deprecated_options, port: T.unsafe(nil), host: T.unsafe(nil), reportable_errors: T.unsafe(nil),
                 extra_middleware: T.unsafe(nil))
  end
...
# source://capybara//lib/capybara/server/animation_disabler.rb#49
Capybara::Server::AnimationDisabler::DISABLE_CSS_MARKUP_TEMPLATE = T.let(T.unsafe(nil), String)

# source://capybara//lib/capybara/server/animation_disabler.rb#60
...
class Capybara::Session
  ...
  # source://capybara//lib/capybara/session.rb#770
  def all(*_arg0, **_arg1, &_arg2); end
  ...
  # source://capybara//lib/capybara/session.rb#839
  def config; end
  ...
  # source://capybara//lib/capybara/session.rb#847
  def server_url; end
  ...
  #
  # source://capybara//lib/capybara/session.rb#810
  def using_wait_time(seconds, &block); end
  ...
  #
  # source://capybara//lib/capybara/session.rb#928
  def _switch_to_window(window = T.unsafe(nil), **options, &window_locator); end

  # @raise [Capybara::WindowError]
  #
  # source://capybara//lib/capybara/session.rb#948
  def _switch_to_window_by_locator; end

  # source://capybara//lib/capybara/session.rb#859
  def accept_modal(type, text_or_options, options, &blk); end

  # source://capybara//lib/capybara/session.rb#908
  def adjust_server_port(uri); end

  # source://capybara//lib/capybara/session.rb#886
  ...
  # source://capybara//lib/capybara/session.rb#855
  ...
  # source://capybara//lib/capybara/session.rb#891
  def scopes; end

  # source://capybara//lib/capybara/session.rb#956
  def synchronize_windows(options, &block); end

  class << self
    # @return [Boolean]
    #
    # source://capybara//lib/capybara/session.rb#835
