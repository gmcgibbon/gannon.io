...
module Reline
  ...
  class << self
    # source://reline//reline.rb#550
    def core; end

    # source://reline//reline.rb#546
    def encoding_system_needs; end

    # source://reline//reline.rb#527
    def insert_text(*args, &block); end

    # source://reline//reline.rb#570
    def line_editor; end

    # source://reline//reline.rb#566
    def ungetc(c); end

    # source://reline//reline.rb#574
...
class Reline::ANSI
  class << self
    # source://reline//reline/ansi.rb#345
    def clear_screen; end

    # source://reline//reline/ansi.rb#254
    def cursor_pos; end

    # source://reline//reline/ansi.rb#360
    def deprep(otio); end

    # @return [Boolean]
    #
    # source://reline//reline/ansi.rb#215
    def empty_buffer?; end

    # source://reline//reline/ansi.rb#37
    def encoding; end

    # source://reline//reline/ansi.rb#333
    ...
    #
    # source://reline//reline/ansi.rb#203
    def getc(timeout_second); end

    # source://reline//reline/ansi.rb#176
    def getc_with_bracketed_paste(timeout_second); end

    # source://reline//reline/ansi.rb#309
    def hide_cursor; end

    # @return [Boolean]
    #
    # source://reline//reline/ansi.rb#211
    def in_pasting?; end

    # source://reline//reline/ansi.rb#156
    def inner_getc(timeout_second); end

    # source://reline//reline/ansi.rb#142
    def input=(val); end

    # source://reline//reline/ansi.rb#289
    def move_cursor_column(x); end

    # source://reline//reline/ansi.rb#301
    def move_cursor_down(x); end

    # source://reline//reline/ansi.rb#293
    def move_cursor_up(x); end

    # source://reline//reline/ansi.rb#147
    def output=(val); end

    # source://reline//reline/ansi.rb#355
    def prep; end

    # source://reline//reline/ansi.rb#226
    def retrieve_keybuffer; end

    # This only works when the cursor is at the bottom of the scroll range
    # For more details, see https://github.com/ruby/reline/pull/577#issuecomment-1646679623
    #
    # source://reline//reline/ansi.rb#339
    def scroll_down(x); end

    # source://reline//reline/ansi.rb#45
    def set_default_key_bindings(config, allow_terminfo: T.unsafe(nil)); end

    # source://reline//reline/ansi.rb#67
    def set_default_key_bindings_ansi_cursor(config); end

    # source://reline//reline/ansi.rb#106
    def set_default_key_bindings_comprehensive_list(config); end

    # source://reline//reline/ansi.rb#89
    def set_default_key_bindings_terminfo(config); end

    # source://reline//reline/ansi.rb#247
    def set_screen_size(rows, columns); end

    # source://reline//reline/ansi.rb#351
    def set_winch_handler(&handler); end

    # source://reline//reline/ansi.rb#321
    def show_cursor; end

    # source://reline//reline/ansi.rb#222
    def ungetc(c); end

    # @return [Boolean]
    #
    # source://reline//reline/ansi.rb#41
    def win?; end

    # source://reline//reline/ansi.rb#151
    def with_raw_input; end
  end
end

# source://reline//reline/ansi.rb#18
Reline::ANSI::ANSI_CURSOR_KEY_BINDINGS = T.let(T.unsafe(nil), Hash)

# source://reline//reline/ansi.rb#6
Reline::ANSI::CAPNAME_KEY_BINDINGS = T.let(T.unsafe(nil), Hash)

# source://reline//reline/ansi.rb#175
Reline::ANSI::END_BRACKETED_PASTE = T.let(T.unsafe(nil), String)

# source://reline//reline/ansi.rb#174
...
class Reline::Core
  ...
  # @raise [ArgumentError]
  #
  # source://reline//reline.rb#140
  def completion_proc=(p); end

  # source://reline//reline.rb#136
  def completion_quote_character; end

  # Returns the value of attribute config.
  #
  # source://reline//reline.rb#65
  def config; end
  ...
  # @raise [ArgumentError]
  #
  # source://reline//reline.rb#164
  def dig_perfect_match_proc=(p); end

  # source://reline//reline.rb#204
  def emacs_editing_mode; end

  # @return [Boolean]
  #
  # source://reline//reline.rb#213
  def emacs_editing_mode?; end

  # source://reline//reline.rb#88
  def encoding; end

  # source://reline//reline.rb#63
  def filename_quote_characters; end

  # source://reline//reline.rb#120
  def filename_quote_characters=(v); end

  # source://reline//reline.rb#217
  def get_screen_size; end

  # @raise [TypeError]
  #
  # source://reline//reline.rb#184
  def input=(val); end

  # source://reline//reline.rb#84
  def io_gate; end
  ...
  # @raise [ArgumentError]
  #
  # source://reline//reline.rb#145
  def output_modifier_proc=(p); end

  # source://reline//reline.rb#63
  def pre_input_hook; end

  # source://reline//reline.rb#160
  ...
  # @raise [ArgumentError]
  #
  # source://reline//reline.rb#150
  def prompt_proc=(p); end

  # source://reline//reline.rb#286
  ...
  #
  # source://reline//reline.rb#392
  def read_io(keyseq_timeout, &block); end
end

# source://reline//reline.rb#49
...
class Reline::Face
  class << self
    # source://reline//reline/face.rb#169
    def [](name); end

    # source://reline//reline/face.rb#173
    def config(name, &block); end

    # source://reline//reline/face.rb#178
    def configs; end

    # source://reline//reline/face.rb#164
    def force_truecolor; end

    # source://reline//reline/face.rb#182
    def load_initial_configs; end

    # source://reline//reline/face.rb#195
    def reset_to_initial_configs; end

    # @return [Boolean]
    #
    # source://reline//reline/face.rb#160
    def truecolor?; end
  end
end
...
class Reline::Face::Config
  # @return [Config] a new instance of Config
  #
  # source://reline//reline/face.rb#62
  def initialize(name, &block); end

  # source://reline//reline/face.rb#84
  def [](name); end

  # source://reline//reline/face.rb#72
  def define(name, **values); end

  # Returns the value of attribute definition.
  #
  # source://reline//reline/face.rb#70
  def definition; end

  # source://reline//reline/face.rb#77
  def reconfigure; end

  private

  # source://reline//reline/face.rb#126
  def format_to_sgr(ordered_values); end

  # @return [Boolean]
  #
  # source://reline//reline/face.rb#153
  def rgb_expression?(color); end

  # source://reline//reline/face.rb#90
  def sgr_rgb(key, value); end

  # source://reline//reline/face.rb#108
  def sgr_rgb_256color(key, value); end

  # source://reline//reline/face.rb#99
  def sgr_rgb_truecolor(key, value); end
end

# source://reline//reline/face.rb#59
Reline::Face::Config::ESSENTIAL_DEFINE_NAMES = T.let(T.unsafe(nil), Array)

# source://reline//reline/face.rb#60
Reline::Face::Config::RESET_SGR = T.let(T.unsafe(nil), String)

# source://reline//reline/face.rb#4
Reline::Face::SGR_PARAMETERS = T.let(T.unsafe(nil), Hash)

class Reline::GeneralIO
  class << self
    # source://reline//reline/general_io.rb#88
    def clear_screen; end

    # source://reline//reline/general_io.rb#63
    def cursor_pos; end

    # source://reline//reline/general_io.rb#114
    def deprep(otio); end

    # source://reline//reline/general_io.rb#13
    def encoding; end

    # source://reline//reline/general_io.rb#82
    def erase_after_cursor; end

    # source://reline//reline/general_io.rb#107
    def finish_pasting; end

    # source://reline//reline/general_io.rb#59
    def get_screen_size; end

    # source://reline//reline/general_io.rb#41
    def getc(_timeout_second); end

    # source://reline//reline/general_io.rb#67
    def hide_cursor; end

    # @return [Boolean]
    #
    # source://reline//reline/general_io.rb#99
    def in_pasting?; end

    # source://reline//reline/general_io.rb#33
    def input=(val); end

    # source://reline//reline/general_io.rb#73
    def move_cursor_column(val); end

    # source://reline//reline/general_io.rb#79
    def move_cursor_down(val); end

    # source://reline//reline/general_io.rb#76
    def move_cursor_up(val); end

    # source://reline//reline/general_io.rb#111
    def prep; end

    # source://reline//reline/general_io.rb#4
    def reset(encoding: T.unsafe(nil)); end

    # source://reline//reline/general_io.rb#85
    def scroll_down(val); end

    # source://reline//reline/general_io.rb#27
    def set_default_key_bindings(_); end

    # source://reline//reline/general_io.rb#91
    def set_screen_size(rows, columns); end

    # source://reline//reline/general_io.rb#94
    def set_winch_handler(&handler); end

    # source://reline//reline/general_io.rb#70
    def show_cursor; end

    # source://reline//reline/general_io.rb#103
    def start_pasting; end

    # source://reline//reline/general_io.rb#55
    def ungetc(c); end

    # @return [Boolean]
    #
    # source://reline//reline/general_io.rb#23
    def win?; end

    # source://reline//reline/general_io.rb#37
    def with_raw_input; end
  end
end

# source://reline//reline.rb#607
...
# source://reline//reline.rb#598
Reline::IOGate = Reline::ANSI

class Reline::Key < Struct
  # @return [Boolean]
  #
  # source://reline//reline.rb#21
  def ==(other); end
...
class Reline::KeyStroke
  ...
  # source://reline//reline/key_stroke.rb#10
  def compress_meta_key(ary); end

  # @return [Boolean]
  #
  # source://reline//reline/key_stroke.rb#46
  def equal?(me, other); end

  # source://reline//reline/key_stroke.rb#87
  def expand(input); end

  # source://reline//reline/key_stroke.rb#71
  def match_status(input); end

  # @return [Boolean]
  #
  # source://reline//reline/key_stroke.rb#22
  def start_with?(me, other); end

  private

  # source://reline//reline/key_stroke.rb#145
  def key_mapping; end

  # returns match status of CSI/SS3 sequence and matched length
  #
  # source://reline//reline/key_stroke.rb#116
  def match_unknown_escape_sequence(input); end
end

# source://reline//reline/key_stroke.rb#4
Reline::KeyStroke::CSI_INTERMEDIATE_BYTES_RANGE = T.let(T.unsafe(nil), Range)

# source://reline//reline/key_stroke.rb#3
...
class Reline::LineEditor
  ...
  #
  # source://reline//reline/line_editor.rb#57
  ...
  # source://reline//reline/line_editor.rb#1839
  def byte_pointer=(val); end

  # source://reline//reline/line_editor.rb#1610
  def call_completion_proc; end

  # source://reline//reline/line_editor.rb#1618
  ...
  # source://reline//reline/line_editor.rb#1757
  ...
  # source://reline//reline/line_editor.rb#1779
  ...
  # source://reline//reline/line_editor.rb#1226
  def editing_mode; end

  # @return [Boolean]
  #
  # source://reline//reline/line_editor.rb#252
  def eof?; end

  # source://reline//reline/line_editor.rb#248
  def finalize; end

  # source://reline//reline/line_editor.rb#1865
  def finish; end

  # @return [Boolean]
  #
  # source://reline//reline/line_editor.rb#1861
  def finished?; end

  # source://reline//reline/line_editor.rb#1535
  def input_key(key); end

  # source://reline//reline/line_editor.rb#1767
  def insert_text(text); end

  # source://reline//reline/line_editor.rb#63
  def io_gate; end

  # source://reline//reline/line_editor.rb#932
  ...
  # source://reline//reline/line_editor.rb#318
  def multiline_off; end

  # source://reline//reline/line_editor.rb#314
  ...
  # source://reline//reline/line_editor.rb#426
  def rerender; end

  # source://reline//reline/line_editor.rb#420
  def rerender_all; end

  # source://reline//reline/line_editor.rb#296
  def reset_line; end

  # source://reline//reline/line_editor.rb#256
  def reset_variables(prompt = T.unsafe(nil), encoding:); end

  # source://reline//reline/line_editor.rb#185
  def resize; end

  # source://reline//reline/line_editor.rb#1679
  def retrieve_completion_block(set_completion_quote_character = T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#67
  def set_pasting_state(in_pasting); end

  # source://reline//reline/line_editor.rb#225
  def set_signal_handlers; end

  # @return [Boolean]
  #
  # source://reline//reline/line_editor.rb#71
  def simplified_rendering?; end

  # source://reline//reline/line_editor.rb#1853
  def whole_buffer; end

  # source://reline//reline/line_editor.rb#1846
  def whole_lines; end

  # source://reline//reline/line_editor.rb#1418
  ...
  # @return [Boolean]
  #
  # source://reline//reline/line_editor.rb#1408
  def argumentable?(method_obj); end

  # source://reline//reline/line_editor.rb#2030
  def backward_char(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2520
  def backward_delete_char(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2698
  def backward_kill_word(key); end

  # source://reline//reline/line_editor.rb#2679
  def backward_word(key); end

  # source://reline//reline/line_editor.rb#2054
  def beginning_of_line(key); end

  # source://reline//reline/line_editor.rb#1877
  def byteinsert(str, byte_pointer, other); end

  # source://reline//reline/line_editor.rb#1871
  def byteslice!(str, byte_pointer, size); end

  # source://reline//reline/line_editor.rb#322
  def calculate_height_by_lines(lines, prompt); end

  # source://reline//reline/line_editor.rb#340
  def calculate_height_by_width(width); end

  # source://reline//reline/line_editor.rb#378
  def calculate_nearest_cursor(line_to_calc = T.unsafe(nil), cursor = T.unsafe(nil), started_from = T.unsafe(nil),
                               byte_pointer = T.unsafe(nil), update = T.unsafe(nil))
  end

  # source://reline//reline/line_editor.rb#875
  def calculate_scroll_partial_screen(highest_in_all, cursor_y); end

  # source://reline//reline/line_editor.rb#1884
  def calculate_width(str, allow_escape_code = T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2745
  def capitalize_word(key); end

  # source://reline//reline/line_editor.rb#81
  def check_mode_string; end

  # source://reline//reline/line_editor.rb#101
  def check_multiline_prompt(buffer, force_recalc: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#859
  def clear_dialog(cursor_column); end

  # source://reline//reline/line_editor.rb#868
  def clear_dialog_with_trap_key(cursor_column); end

  # source://reline//reline/line_editor.rb#2665
  def clear_screen(key); end

  # source://reline//reline/line_editor.rb#1205
  def clear_screen_buffer(prompt, prompt_list, prompt_width); end

  # source://reline//reline/line_editor.rb#1280
  def complete(list, just_show_list = T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#1234
  def complete_internal_proc(list, is_menu); end

  # source://reline//reline/line_editor.rb#2801
  def copy_for_vi(text); end

  # source://reline//reline/line_editor.rb#2597
  def delete_char(key); end

  # source://reline//reline/line_editor.rb#2624
  def delete_char_or_list(key); end

  # source://reline//reline/line_editor.rb#671
  def dialog_range(dialog, dialog_y); end

  # source://reline//reline/line_editor.rb#2757
  def downcase_word(key); end

  # source://reline//reline/line_editor.rb#3100
  def ed_argument_digit(key); end

  # source://reline//reline/line_editor.rb#2665
  def ed_clear_screen(key); end

  # source://reline//reline/line_editor.rb#3012
  def ed_delete_next_char(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2930
  ...
  #
  # source://reline//reline/line_editor.rb#2548
  ...
  # do nothing
  #
  # source://reline//reline/line_editor.rb#1911
  ...
  # source://reline//reline/line_editor.rb#2688
  ...
  #
  # source://reline//reline/line_editor.rb#2586
  def em_kill_line(key); end

  # source://reline//reline/line_editor.rb#2789
  def em_kill_region(key); end

  # source://reline//reline/line_editor.rb#2757
  def em_lower_case(key); end

  # source://reline//reline/line_editor.rb#3295
  def em_meta_next(key); end

  # source://reline//reline/line_editor.rb#2670
  def em_next_word(key); end

  # source://reline//reline/line_editor.rb#3279
  ...
  # source://reline//reline/line_editor.rb#2648
  ...
  # source://reline//reline/line_editor.rb#2284
  def forward_search_history(key); end

  # source://reline//reline/line_editor.rb#2670
  def forward_word(key); end

  # source://reline//reline/line_editor.rb#2074
  ...
  # @return [Boolean]
  #
  # source://reline//reline/line_editor.rb#1412
  def inclusive?(method_obj); end

  # source://reline//reline/line_editor.rb#2192
  def incremental_search_history(key); end

  # source://reline//reline/line_editor.rb#332
  def insert_new_line(cursor_line, next_line); end

  # source://reline//reline/line_editor.rb#1888
  def key_delete(key); end

  # source://reline//reline/line_editor.rb#1896
  ...
  # source://reline//reline/line_editor.rb#1230
  def menu(target, list); end

  # source://reline//reline/line_editor.rb#1182
  def modify_lines(before, force_recalc: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#1324
  def move_completed_list(list, direction); end

  # source://reline//reline/line_editor.rb#368
  def move_cursor_down(val); end

  # source://reline//reline/line_editor.rb#359
  def move_cursor_up(val); end

  # source://reline//reline/line_editor.rb#2439
  def next_history(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#1495
  def normal_char(key); end

  # source://reline//reline/line_editor.rb#658
  def padding_space_with_escape_sequences(str, width); end

  # source://reline//reline/line_editor.rb#2388
  def previous_history(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#1640
  def process_auto_indent; end

  # source://reline//reline/line_editor.rb#1913
  def process_insert(force: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#1438
  def process_key(key, method_symbol); end

  # source://reline//reline/line_editor.rb#1994
  def quoted_insert(str, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#665
  ...
  # source://reline//reline/line_editor.rb#3225
  ...
  # source://reline//reline/line_editor.rb#1192
  def show_menu; end

  # source://reline//reline/line_editor.rb#344
  ...
  #
  # source://reline//reline/line_editor.rb#2571
  ...
  # source://reline//reline/line_editor.rb#769
  def update_each_dialog(dialog, cursor_column); end

  # source://reline//reline/line_editor.rb#2811
  def vi_add(key); end

  # source://reline//reline/line_editor.rb#2925
  def vi_add_at_eol(key); end

  # source://reline//reline/line_editor.rb#2951
  def vi_change_meta(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2816
  def vi_command_mode(key); end

  # source://reline//reline/line_editor.rb#2969
  def vi_delete_meta(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2900
  def vi_delete_prev_char(key); end

  # source://reline//reline/line_editor.rb#2881
  def vi_end_big_word(key, arg: T.unsafe(nil), inclusive: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2996
  def vi_end_of_transmission(key); end

  # source://reline//reline/line_editor.rb#2842
  def vi_end_word(key, arg: T.unsafe(nil), inclusive: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2996
  def vi_eof_maybe(key); end

  # source://reline//reline/line_editor.rb#2050
  def vi_first_print(key); end

  # source://reline//reline/line_editor.rb#3054
  def vi_histedit(key); end

  # source://reline//reline/line_editor.rb#2807
  def vi_insert(key); end

  # source://reline//reline/line_editor.rb#2920
  def vi_insert_at_bol(key); end

  # source://reline//reline/line_editor.rb#3265
  ...
  # source://reline//reline/line_editor.rb#3031
  def vi_to_history_line(key); end

  # source://reline//reline/line_editor.rb#3164
  def vi_to_next_char(key, arg: T.unsafe(nil), inclusive: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#3221
  def vi_to_prev_char(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2984
  def vi_yank(key, arg: T.unsafe(nil)); end

  # source://reline//reline/line_editor.rb#2946
  def vi_zero(key); end
...
class Reline::LineEditor::DialogProcScope
  ...
  # source://reline//reline/line_editor.rb#524
  def context; end

  # source://reline//reline/line_editor.rb#557
  def cursor_pos; end
  ...
  # source://reline//reline/line_editor.rb#553
  def key; end
  ...
  # source://reline//reline/line_editor.rb#549
  def set_key(key); end
end

# source://reline//reline/line_editor.rb#55
...
module Reline::Terminfo
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://reline//reline/terminfo.rb#151
    def enabled?; end

    # source://reline//reline/terminfo.rb#80
    def setupterm(term, fildes); end

    # @raise [TerminfoError]
    #
    # source://reline//reline/terminfo.rb#127
    def tigetflag(capname); end

    # @raise [TerminfoError]
    #
    # source://reline//reline/terminfo.rb#139
    def tigetnum(capname); end

    # @raise [TerminfoError]
    #
    # source://reline//reline/terminfo.rb#109
    def tigetstr(capname); end

    # source://reline//reline/terminfo.rb#119
...
class Reline::Terminfo::StringWithTiparm < String
  # for method chain
  #
  # source://reline//reline/terminfo.rb#104
  def tiparm(*args); end
end

# source://reline//reline.rb#16
Reline::USERNAME_COMPLETION_PROC = T.let(T.unsafe(nil), T.untyped)

class Reline::Unicode
  class << self
    # source://reline//reline/unicode.rb#105
    def calculate_width(str, allow_escape_code = T.unsafe(nil)); end

    # source://reline//reline/unicode.rb#307
    def ed_transpose_words(line, byte_pointer); end

    # source://reline//reline/unicode.rb#267
    def em_backward_word(line, byte_pointer); end

    # source://reline//reline/unicode.rb#287
    def em_big_backward_word(line, byte_pointer); end

    # source://reline//reline/unicode.rb#218
    def em_forward_word(line, byte_pointer); end

    # source://reline//reline/unicode.rb#238
...
# Ambiguous
#
# source://reline//reline/unicode/east_asian_width.rb#158
...
# Neutral
#
# source://reline//reline/unicode/east_asian_width.rb#341
Reline::Unicode::EastAsianWidth::TYPE_N = T.let(T.unsafe(nil), Regexp)

# Narrow
#
# source://reline//reline/unicode/east_asian_width.rb#147
...
# source://reline//reline/unicode.rb#57
Reline::Unicode::HalfwidthDakutenHandakuten = T.let(T.unsafe(nil), Regexp)

# source://reline//reline/unicode.rb#59
