...
class Rack::MiniProfiler::Config
  ...
  #
  # source://rack-mini-profiler//lib/mini_profiler/config.rb#91
  def assets_url; end

  # source://rack-mini-profiler//lib/mini_profiler/config.rb#109
...
class Rack::MiniProfiler::FileStore < ::Rack::MiniProfiler::AbstractStore
  ...
  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#143
  def allowed_tokens; end

  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#159
  def cleanup_cache; end

  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#137
  def flush_tokens; end

  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#131
  def get_unviewed_ids(user); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#100
  def load(id); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#94
  def save(page_struct); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#125
  def set_all_unviewed(user, ids); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#106
  def set_unviewed(user, id); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#115
  def set_viewed(user, id); end
end
...
# source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#45
...
class Rack::MiniProfiler::FileStore::FileCache
  ...
  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#26
  def []=(key, val); end

  private

  # source://rack-mini-profiler//lib/mini_profiler/storage/file_store.rb#39
  def path(key); end
end
...
class Rack::MiniProfiler::MemcacheStore < ::Rack::MiniProfiler::AbstractStore
  ...
  # source://rack-mini-profiler//lib/mini_profiler/storage/memcache_store.rb#62
  def allowed_tokens; end

  # source://rack-mini-profiler//lib/mini_profiler/storage/memcache_store.rb#58
  def flush_tokens; end

  # source://rack-mini-profiler//lib/mini_profiler/storage/memcache_store.rb#54
  def get_unviewed_ids(user); end
  ...
  # source://rack-mini-profiler//lib/mini_profiler/storage/memcache_store.rb#50
  def set_all_unviewed(user, ids); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/memcache_store.rb#30
  def set_unviewed(user, id); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/memcache_store.rb#40
  def set_viewed(user, id); end
end
...
class Rack::MiniProfiler::RedisStore < ::Rack::MiniProfiler::AbstractStore
  ...
  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#85
  def allowed_tokens; end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#68
  def diagnostics(user); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#165
  def fetch_snapshots(batch_size: T.unsafe(nil), &blk); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#76
  def flush_tokens; end

  # Remove expired ids from the unviewed sorted set and return the remaining ids
  #
  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#62
  def get_unviewed_ids(user); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#24
  def load(id); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#199
  def load_snapshot(id); end
  ...
  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#134
  def push_snapshot(page_struct, config); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#20
  def save(page_struct); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#45
  def set_all_unviewed(user, ids); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#36
  def set_unviewed(user, id); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#57
  def set_viewed(user, id); end
  ...
  #
  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#81
  def simulate_expire; end

  private

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#242
  def cached_redis_eval(script, script_sha, reraise: T.unsafe(nil), argv: T.unsafe(nil), keys: T.unsafe(nil)); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#219
  def prefixed_id(id); end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#223
  def redis; end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#230
  def snapshot_counter_key; end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#238
  def snapshot_hash_key; end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#234
  def snapshot_zset_key; end

  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#215
  def user_key(user); end

  # only used in tests
  #
  # source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#255
  def wipe_snapshots_data; end
end

# source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#113
Rack::MiniProfiler::RedisStore::COUNTER_LUA = T.let(T.unsafe(nil), String)

# source://rack-mini-profiler//lib/mini_profiler/storage/redis_store.rb#122
